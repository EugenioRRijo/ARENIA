...
| RF‑27 | El sistema advertirá cuando el rendimiento introducido se aparte del comportamiento observado, sin impedir el registro | Esencial | UC‑06 | I6.1, I6.2 | detección cubierta: `tests/unit/test_anomalias.py` (`evaluar_rendimiento`: desviado → atípico, coherente → no, histórico corto → sin veredicto); la advertencia dentro del flujo de registro, pendiente (Sesión I6.2) |
...
| UC‑06 | RF‑25, RF‑26, RF‑27 | `tests/unit/test_contracts.py` (invariante de `Rendimiento`, I0.1); `tests/unit/test_anomalias.py` (detección de desviación, I6.1); registro, dispersión y advertencia pendientes (Sesión I6.2) | I0.1, I6.1, I6.2 | 2 |
| UC‑07 | RF‑28, RF‑29 | `tests/unit/test_anomalias.py` (precios atípicos, I6.1); estimación y métricas pendientes (Sesión I6.3, `docs/resultados_ml.md`) | I6.1, I6.3 | 5 |
