...
| Documento | Estado | Sesión que lo completa |
|---|---|---|
...
| api.json | pendiente | F.1 |
| plan_pruebas.md (IEEE 829), calidad_iso25010.md | pendientes | F.2 |
...
| Archivo | Uso |
|---|---|
| `Bases_Anteproyecto_BIM5D_APU.docx` | bases del anteproyecto: problema, objetivos, marco teórico, metodología, arquitectura, riesgos |
| `Estado_del_Arte_BIM5D_ML_APU.pdf` | revisión de literatura para el capítulo II |

La evidencia primaria del caso de estudio está en [`../data/linea_base/APUS_CLINICA.pdf`](../data/linea_base/APUS_CLINICA.pdf).
