...
Ma et al. (2011) aplicaron y extendieron el estándar IFC para la estimación de costos en licitaciones de obra en China. Su aporte a esta investigación es mostrar que el formato abierto IFC puede adaptarse a las reglas de un sistema nacional de estimación, que es la decisión que aquí se adopta al tomar IFC como frontera entre el modelado y el cálculo del presupuesto venezolano.
...
Tayefeh Hashemi et al. (2020) realizaron una revisión sistemática de las técnicas de aprendizaje automático empleadas para estimar y predecir costos de proyectos de construcción. Aporta el panorama contra el que se contrasta la decisión de degradar la técnica predictiva cuando los datos son escasos.
...
Garnica Patiño (2017) propuso, en la Universidad Metropolitana, una metodología integral de gestión de construcción eficiente que coordina las fases de diseño, ejecución y puesta en marcha sobre un modelo tridimensional, integrando BIM con el PMBOK y con Lean Construction. Aporta el antecedente de concebir BIM como eje de coordinación de la gestión de la construcción, y no solo como herramienta de modelado.

En el plano institucional, el Colegio de Ingenieros de Venezuela presentó una propuesta de ley marco para un plan nacional de adopción de BIM (Colegio de Ingenieros de Venezuela, 2022), lo que sitúa la incorporación de BIM como un asunto de interés gremial en el país. Para esta investigación, ese interés respalda la pertinencia institucional de adaptar BIM‑5D a la estructura de costos venezolana, expuesta en la justificación institucional (sección 1.4.4).
...
### 2.3.1 Norma COVENIN‑MINDUR 2000‑2: mediciones y codificación de partidas

La norma venezolana COVENIN‑MINDUR 2000, en su parte II.A dedicada a las edificaciones, establece las mediciones y la codificación de partidas para estudios, proyectos y construcción (COVENIN, 1999). Para esta investigación cumple dos funciones. En primer lugar, ofrece la codificación normalizada contra la que se asocian las descripciones de partidas redactadas libremente. En segundo lugar, cada partida codificada lleva su unidad de medición, de modo que una discrepancia entre la unidad del cómputo métrico y la unidad del análisis de precios unitarios constituye una inconsistencia verificable, como la que presenta el caso didáctico con la tubería medida en metros y analizada por pieza.

### 2.3.2 Convención colectiva de la industria de la construcción

La convención colectiva de trabajo de la industria de la construcción fija las condiciones económicas de la relación laboral en el sector. La vigente al cierre de esta revisión se publicó en la Gaceta Oficial N.º 6.752 Extraordinario, del 6 de julio de 2023; rige desde la fecha de su depósito, dura veinticuatro meses y sus disposiciones continúan aplicándose hasta que otras las sustituyan. Sus partes son las cámaras de la construcción, las federaciones y los sindicatos del sector, y alcanza a las empresas afiliadas a esas cámaras (Convención Colectiva de la Industria de la Construcción, 2023).

El factor de costos asociados al salario no aparece en su texto. Quien lo calcula y lo publica es el Colegio de Ingenieros de Venezuela, cuyo Departamento de Análisis y Costos advierte que los factores de sus guías son referencias, que el cálculo se apoya en las cláusulas de la convención y en la legislación laboral, y que cada empresa debería calcular el suyo para cada obra (Colegio de Ingenieros de Venezuela, 2018). Por eso esta investigación no deriva el valor del FCAS de la convención: lo trata como un parámetro del caso de estudio, explícito y modificable. Esa decisión mantiene el modelo de cálculo válido para cualquier convención vigente, porque el factor entra como dato y no como constante del cálculo.

### 2.3.3 Clasificación de estimaciones de costos de AACE International

La práctica recomendada 18R‑97 de AACE International clasifica las estimaciones de costos en cinco clases. Lo que determina la clase es la madurez de la definición del proyecto, que se juzga por el estado de sus entregables clave de planificación y diseño y no por un porcentaje de avance; cada clase asocia, además, un uso típico, una metodología y un rango de exactitud (AACE International, 2020). La clase 3 corresponde a una definición de entre el 10 % y el 40 % y a la autorización o el control del presupuesto. Su rango típico de exactitud va de −10 % a −20 % en el extremo inferior y de +10 % a +30 % en el superior; la misma práctica advierte que el rango debe determinarse mediante el análisis de riesgo del proyecto específico y que, con una contingencia adecuadamente tratada, cerca del 80 % de los proyectos cae dentro de los rangos indicados (AACE International, 2020).
...
La 18R‑97 se formula para las industrias de proceso. AACE International mantiene una práctica específica para la edificación y la construcción general, la 56R‑08, cuyo ámbito corresponde al del caso de estudio. En ella, la clase 3 abarca una definición del proyecto del 10 % al 40 %, se destina al desarrollo del diseño y a la autorización del presupuesto, y su rango de exactitud esperado va de −5 % a −15 % en el extremo inferior y de +10 % a +20 % en el superior (AACE International, 2012). Es, por tanto, más estrecho que el de la 18R‑97: un presupuesto juzgado con la práctica sectorial tendría menos holgura. Cuál de las dos adopta la investigación es una decisión que corresponde al marco metodológico; mientras tanto, el contraste se realiza con el rango de la 18R‑97, que es el declarado en la especificación de requisitos del sistema, y el de la 56R‑08 queda registrado como referencia sectorial más exigente.
